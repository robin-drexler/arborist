...
1. mark everything that's shadowed by anything in the bundle
2. anything with edgesIn from outside the set, mark not-extraneous, remove from set
3. continue until no change
4. remove everything in the set from the tree
       */
